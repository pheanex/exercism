simple_names = ['', 'one', 'two', 'three', 'four', 'five', 'six', 'seven',
                'eight', 'nine', 'ten', 'eleven', 'twelve', 'thirteen',
                'fourteen', 'fifteen', 'sixteen', 'seventeen', 'eighteen',
                'nineteen']
decadic_names = ['', '', 'twenty', 'thirty', 'forty', 'fifty', 'sixty',
                 'seventy', 'eighty', 'ninety']
mill_names = ['thousand', 'million', 'billion', 'trillion', 'quadrillion',
...
def say_under_1000(number):
    ...
    return say_under_20(
        number // 100) + " hundred and " + say_under_100(number % 100)
    ...
    for mill_name, block in zip(mill_names, blocks[::-1][1:]):
        if block != 0:
            if number_name == "":
                ...
                number_name = say_under_1000(
                    block) + " " + mill_name + " " + number_name
    return number_name
